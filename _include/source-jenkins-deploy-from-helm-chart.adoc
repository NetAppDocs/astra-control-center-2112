Learn how to deploy Jenkins from the https://bitnami.com/stack/jenkins/helm[Bitnami Helm chart^]. After you deploy Jenkins on your cluster, you can register the application with Astra Control.
