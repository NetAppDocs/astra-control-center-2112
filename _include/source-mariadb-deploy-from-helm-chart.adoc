Learn how to deploy MariaDB from the https://bitnami.com/stack/mariadb/helm[Bitnami Helm chart^]. After you deploy MariaDB on your cluster, you can manage the application with Astra Control.
