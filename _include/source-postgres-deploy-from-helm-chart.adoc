Learn how to deploy Postgres from the https://bitnami.com/stack/postgresql/helm[Bitnami Helm chart^]. After you deploy Postgres on your cluster, you can register the application with Astra Control.
